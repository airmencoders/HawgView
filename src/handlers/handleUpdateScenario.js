...
const handleUpdateScenario = data => {
  ...
  if (json !== undefined) {
    ...
    v1Markers.forEach((marker, index) => {
      ...
      if (marker.icon.iconUrl.indexOf('artillery') !== -1) {
        arty = {
          arty: true,
          display: true,
        }
      ...
      console.log(`v2 marker ${index}:`, v2)
    ...
    console.log('v2 Scenario:', scenario)

    //setHistory([...history, scenario])
    //setStep(step + 1)
  }*/
}

export default handleUpdateScenario